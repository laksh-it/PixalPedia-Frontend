  ...
  const handleUserClick = () => {
    ...
    if (onProfileClick && typeof onProfileClick === 'function') {
      ...
      if (userTargetAccountId === loggedInUserId) {
        navigate(`/desktop/profile`); // Navigate to the general logged-in user's profile route
      } else {
        navigate(`/desktop/profile/${userProfileId}`); // Navigate to the specific profile ID
      }
    }
  };
