  ...
  const handleUserClick = () => {
    ...
    if (onProfileClick && typeof onProfileClick === 'function') {
      ...
      if (userTargetAccountId === loggedInUserId) {
        navigate(`/mobile/profile`); // Navigate to the general logged-in user's profile route
      } else {
        navigate(`/mobile/profile/${userProfileId}`); // Navigate to the specific profile ID
      }
    }
  };
