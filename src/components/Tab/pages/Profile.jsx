...
import WallpaperCard from '../elements/TabProWallpaperCard';
import UserCard from '../elements/TabUserCard'; // This will need an unfollow prop
import RemoveFollowerCard from '../elements/TabRemoveFollowerCard';
...
const Profile = () => {
  ...
  const handleProfileClick = (navProfileId) => {
    if (navProfileId && String(navProfileId) === String(loggedInUserId)) { // Ensure string comparison
      ...
      navigate(`/tablet/profile/${navProfileId}`);
    }
  };
  ...
  const handleHashtagClick = (hashtag) => {
    navigate(`/tablet/search?hashtag=${hashtag}`);
  };
              ...
              <div className="flex flex-col md:flex-row md:items-center md:space-x-6 mb-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="relative">
                    <button
                      onClick={() => navigate('/tablet/settings')}
