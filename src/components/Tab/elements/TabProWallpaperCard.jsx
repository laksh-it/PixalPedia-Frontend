...
import UserCard from '../elements/TabUserCard'; // Keep UserCard as it's a distinct component for users in the likes modal
...
const WallpaperCard = ({
  ...
  const wallpaperPageBaseUrl = `${window.location.origin}/tablet/wallpaper`; // Corrected base URL for wallpaper page
...
const handleDownload = async (e) => {
  ...
  const handleProfileNavigation = (e) => {
    ...
    if (profileId) {
      navigate(`/tablet/profile/${profileId}`); // Ensure this path is correct for desktop
    } else {
